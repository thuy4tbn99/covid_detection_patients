...
def split_address_normal(address_string):
    ...
    villages = ['phường 16', 'p16', 'tăng nhơn phú b', 'thủ thiêm', 'linh đông', 'bình trưng tây', 'hoà thạnh',
                'phường 07', 'p7', 'phường 08', 'p8', 'thảo điền', 'tân chánh hiệp', 'hiệp thành', 'thạnh an',
                'vĩnh lộc a',
                ...
                'cầu kho', 'thái mỹ', 'phạm văn hai', 'hưng long', 'tân hiệp', 'thạnh xuân', 'trung mỹ tây',
                'hiệp bình chánh',
                'phú thuận', 'tân hưng', 'an lạc', 'tân thới hoà', 'thạnh lộc', 'long thạnh mỹ', 'bình hưng hoà b',
                'bà điểm',
                ...
                'phú hòa đông', 'phạm ngũ lão', 'bình an', 'tân thạnh tây', 'phước long a', 'bình chánh', 'linh trung',
                'bình trị đông', 'bến nghé', 'long bình', 'tân thuận tây', 'tăng nhơn phú a', 'phước thạnh',
                ...
                'phường 18', 'p18', 'tân tạo', 'phước hiệp', 'cần thạnh', 'phường 13', 'p13', 'tân quy',
                'hiệp bình phước',
                'phường 15', 'phường 05', 'long hòa', 'hòa phú', 'cầu ông lãnh', 'cát lái', 'thới an', 'tân thuận đông',
                'tân thới hiệp', 'xuân thới sơn', 'thạnh mỹ lợi', 'tân kiên', 'lý nhơn', 'an lạc a', 'trung an',
                'phong phú',
                'bình hưng', 'nguyễn cư trinh', 'phường 3', 'p3', 'phường 6', 'p6', 'phường 19', 'p19', 'tân túc',
                'phú thạnh', 'phường 14', 'p14', 'tân phú trung', 'p. tân phú', 'tân phú', 'tân thới nhì', 'phường 22',
                'p22',
...
def extract_epidemiological_info(text_block):
    ...
    epi_info = {'epidemiology': [], 'positve_case_contact': '', 'test_dates': [],
                'positive_place': 'Không rõ thông tin'}
...
def extract_positive_place(block_text):
    ...
    if regex.search(block_text) and da_cach_ly is False:
        ...
        if re.compile("(?:[Tt]iếp [Xx]úc (?:[Gg]ần)?)|(?:[Tt]rong khu cách ly)|(?:F1)|(?:F0)|" + regex_cach_ly).search(
                block_text):
            print('k')
            return 'Cách ly'
            ...
            print('e')
            if re.compile("(?:[Gg]ần) (?:(?:(?:[a-z" + VN_regex_norm + "]+) ){1,4})(?:[Pp]hong [Tt][oỏ][aả])").search(
                    block_text) is None:
                return 'Cách ly'
            elif re.compile("trong (?:(?:(?:[a-z" + VN_regex_norm + "]+) ){1,4})(?:[Pp]hong [Tt][oỏ][aả])").search(
                    block_text):
                return 'Cách ly'
